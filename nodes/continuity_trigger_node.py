"""AWPV2ContinuityTrigger — ComfyUI node for Continuity trigger evaluation."""
...
class AWPV2ContinuityTrigger:
    """Evaluate whether Continuity Agent should be triggered."""
    ...
    RETURN_TYPES = ("CONTINUITY_TRIGGER_RESULT",)
