"""EmotionRelationshipTriggerDiagnostics — diagnostics for trigger evaluation.

schemaId: awp.rp.emotion-relationship-trigger-diagnostics.v1
"""
from __future__ import annotations
from dataclasses import dataclass, field
from typing import Any

SCHEMA_ID = "awp.rp.emotion-relationship-trigger-diagnostics.v1"
SCHEMA_VERSION = 1

@dataclass
class EmotionRelationshipTriggerDiagnostics:
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "emotion_relationship_domains": self.emotion_relationship_domains,
    ...
    @classmethod
    def from_dict(cls, data: dict[str, Any]) -> EmotionRelationshipTriggerDiagnostics:
        return cls(
            ...
            emotion_relationship_domains=data.get("emotion_relationship_domains", []),
