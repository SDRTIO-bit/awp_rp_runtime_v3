"""WorldLifeRisk — risk assessment for world-life candidates.

schemaId: awp.rp.world-life-risk.v1
"""
...
SCHEMA_ID = "awp.rp.world-life-risk.v1"
SCHEMA_VERSION = 1


class WorldLifeRiskLevel(str, Enum):
    NONE = "none"
    LOW = "low"
    MEDIUM = "medium"
    HIGH = "high"
...
class WorldLifeRisk:
    ...
    risk_id: str = ""
    risk_level: WorldLifeRiskLevel = WorldLifeRiskLevel.NONE
    description: str = ""
    ...
    @classmethod
    def from_dict(cls, data: dict[str, Any]) -> WorldLifeRisk:
        level_raw = data.get("risk_level", "none")
        try:
            level = WorldLifeRiskLevel(level_raw)
        except ValueError:
            level = WorldLifeRiskLevel.NONE
        return cls(
