"""RelationshipEvidence — evidence supporting an emotion/relationship candidate.

schemaId: awp.rp.relationship-evidence.v1
"""
from __future__ import annotations
from dataclasses import dataclass, field
from typing import Any

SCHEMA_ID = "awp.rp.relationship-evidence.v1"
SCHEMA_VERSION = 1
