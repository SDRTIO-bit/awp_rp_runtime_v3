"""OpportunityTriggerDiagnostics — diagnostics for trigger evaluation.

schemaId: awp.rp.opportunity-trigger-diagnostics.v1
"""
from __future__ import annotations
from dataclasses import dataclass, field
from typing import Any

SCHEMA_ID = "awp.rp.opportunity-trigger-diagnostics.v1"
SCHEMA_VERSION = 1

@dataclass
class OpportunityTriggerDiagnostics:
    ...
    def to_dict(self) -> dict[str, Any]:
        return {
            ...
            "max_opportunity_count": self.max_opportunity_count,
    ...
    @classmethod
    def from_dict(cls, data: dict[str, Any]) -> OpportunityTriggerDiagnostics:
        return cls(
            ...
            opportunity_domains=data.get("opportunity_domains", []),
            focus_entities=data.get("focus_entities", []),
            risk_level=data.get("risk_level", "none"),
            max_opportunity_count=data.get("max_opportunity_count", 2),
