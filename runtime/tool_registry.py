...
V1_ALLOWED_TOOLS: dict[str, ToolRegistration] = {
    "worldbook_lookup": ToolRegistration(
        ...
        allowed_roles=["director", "world-life", "opportunity", "history-recall", "continuity"],
    ...
    "accepted_turn_lookup": ToolRegistration(
        ...
        allowed_roles=["history-recall", "world-life", "opportunity", "continuity"],
        allowed_scopes=["card", "session"],
        side_effect_free=True,
    ),
    "active_memory_lookup": ToolRegistration(
        ...
        allowed_roles=["history-recall", "world-life", "continuity"],
        allowed_scopes=["card", "session"],
        side_effect_free=True,
    ),
    # D3: World-Life tools
    "event_stage_lookup": ToolRegistration(
        ...
        allowed_roles=["world-life", "continuity"],
        allowed_scopes=["card", "session"],
        side_effect_free=True,
    ),
